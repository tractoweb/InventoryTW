...
export default async function DocumentPrintPreviewPage({ params }: { params: { documentId: string } }) {
  ...
  return (
    <div className="page" style={{ padding: 16, fontFamily: 'system-ui', color: '#111' }}>
      <style>{`
        @page { margin: 12mm; }
        html, body { background: #fff; }
        h1,h2,h3 { margin: 0 0 8px 0; }
        table { width: 100%; border-collapse: collapse; }
        th, td { border-bottom: 1px solid #ddd; padding: 6px 4px; font-size: 12px; vertical-align: top; }
        th { text-align: left; }
        .muted { color: #666; }
        ...
        /* Better embedded preview UX (iframe) */
        @media screen {
        ...
        /* Avoid overly wide tables on small viewports */
