...
const menuGroups: MenuGroup[] = [
  ...
  },
  {
    ...
    label: "Reportes",
    icon: BarChart3,
    items: [{ href: "/reports", label: "Informes", icon: BarChart3 }],
  },
  {
    key: "admin",
    ...
    icon: Shield,
    items: [
      { href: "/users", label: "Usuario & Seguridad", icon: Shield, minLevel: 1 },
      { href: "/audit", label: "Auditoría", icon: History, minLevel: 1 },
      { href: "/payment-methods", label: "Formas de pago", icon: CreditCard, minLevel: 1 },
      { href: "/taxes", label: "Tasas de impuestos", icon: Percent, minLevel: 1 },
      { href: "/company", label: "Mi empresa", icon: Building2, minLevel: 1 },
    ],
  },
  {
    key: "tools",
